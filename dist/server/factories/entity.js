 ...
 * @param {Object} props
 * @returns {Entity}
 */function createTeam(session,props){var entity=new _entity2.default(props);var onPointsUpdate=function onPointsUpdate(updateProps,dispatch){var _this=this;if(updateProps.players&&updateProps.numFlags&&this.shouldGivePoints()){(function(){var points=updateProps.numFlags*POINTS_PER_FLAG;(0,_lodash.forEach)(updateProps.players,function(playerId){dispatch((0,_game.givePoints)(playerId,points))});_this.pointsGiven()})()}};entity.addComponent(new _points2.default(onPointsUpdate));return entity} /**
 *
 * @param {Session} session
 * @param {Object} props
 * @returns {Entity}
