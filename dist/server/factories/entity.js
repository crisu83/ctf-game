'use strict';Object.defineProperty(exports,'__esModule',{value:true});exports.createEntity=createEntity;var _lodash=require('lodash');var _vendor=require('../helpers/vendor');var _entity=require('../../shared/game/entity');var _entity2=_interopRequireDefault(_entity);var _health=require('../game/components/health');var _health2=_interopRequireDefault(_health);var _points=require('../game/components/points');var _points2=_interopRequireDefault(_points);var _constants=require('../constants');var _entity3=require('../actions/entity');var _constants2=require('../../shared/constants');function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}} /**
 *
 * @param {Session} session
 * @param {Object} props
 * @returns {Entity}
 */ /*eslint no-shadow: 0*/ /*eslint no-unused-vars: 0*/function createPlayer(session,props){var entity=new _entity2.default(props);var onHealthComponentUpdate=function onHealthComponentUpdate(props,dispatch){if(!props.isDead&&props.currentHealth<=0){dispatch((0,_entity3.killEntity)(props.id,props.lastAttackerId)); // Automatically revive the entity in a while
setTimeout(function(){dispatch((0,_entity3.beginRevive)(props.id));setTimeout(function(){dispatch((0,_entity3.endRevive)(props.id))},500)},props.reviveDuration)}};entity.addComponent(new _health2.default(onHealthComponentUpdate));return entity} /**
 *
 * @param {Session} session
 * @param {Object} props
 * @returns {Entity}
