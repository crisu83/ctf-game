...
function createKnight(state, group, props) {
  ...
  sprite.animations.add('idle', [0], FRAME_RATE, true);
  sprite.animations.add('runDown', [0, 1, 2, 3], FRAME_RATE, true);
  sprite.animations.add('runLeft', [4, 5, 6, 7], FRAME_RATE, true);
  sprite.animations.add('runUp', [8, 9, 10, 11], FRAME_RATE, true);
  sprite.animations.add('runRight', [12, 13, 14, 15], FRAME_RATE, true);
